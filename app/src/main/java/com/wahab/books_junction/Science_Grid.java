...
public class Science_Grid extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //customtext.setText("Science Fiction");
        ...
        getSupportActionBar().setTitle(R.string.science_fiction);
       ...
       Intent i = getIntent();
        gridimage.setImageResource(i.getIntExtra("image1",1));

        txt1.setText(i.getStringExtra("bookname"));
        txt2.setText(i.getStringExtra("bookprice"));

        txt3.setText(i.getStringExtra("bookauthor"));
